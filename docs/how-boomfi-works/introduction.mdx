...
<Card 
  title="Pricing & Fees" 
  link="/docs/pricing-and-fees" 
  image="/media/cards/pricing_fees.svg"
/>

<Card 
  title="Account Verification & Limits" 
  link="/docs/account-verification-limits" 
  image="/media/images/account-verification-limits.svg"
/>

<Card 
  title="Unsupported Countries" 
  link="/docs/unsupported-countries" 
  image="/media/images/unsupported-countries.svg"
/>

<Card 
  title="Unsupported Business Activities" 
  link="/docs/unsupported-business-activities" 
  image="/media/images/unsupported-business-activities.svg"
/>