...
<Warning>
  ...
  ![](/images/docs/fedf157da3fa3939b31a097312435b582d2653467c850b756bece3d656564532-unpaid-invoice-error.png)
</Warning>
...
![](/images/docs/3fc46a954c5c5504b17d13df95953a5d8a40cc0d440cd569580db054914e02cb-search-plugin.png)

3. Select our integration and activate it.

![](/images/docs/338cea9ed83faadea9f8f4fa01d42ef51d650a0eeef2f259abca8e819587300a-plugin.png)
...
![](/images/docs/3e6d473610fd96d59aa1675195084bb57e7a6157c5231cbef9e93bdea96be792-plugin-config.png)
...
* * [How to integrate](#how-to-integrate)
    ...
    * [Step 1: Sign up to BoomFi](#step-1-sign-up-to-boomfi)
    * [Step 2: Generate an API Key](#step-2-generate-an-api-key)
    * [Step 3: Create Payment Links](#step-3-create-payment-links)
    * [Step 4: Install BoomFi's Plugin on WHMCS](#step-4-install-boomfis-plugin-on-whmcs)
